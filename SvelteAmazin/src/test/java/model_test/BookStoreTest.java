...
public class BookStoreTest {
    ...
    void testAddAndGetBookByIsbn() {
        BookStore store = new BookStore();
        Book b = new Book("978-0-111111-11-1", "Test Title", "Author Name", "Publisher", "Desc", 19.99, 5);
    ...
    void testSearchBooksCaseInsensitiveAndLiveList() {
        ...
        Book b1 = new Book("1", "Java Programming", "Alice Example", "Pub", "Desc", 10.0, 1);
        Book b2 = new Book("2", "Advanced Java", "Bob Example", "Pub", "Desc", 15.0, 2);
        Book b3 = new Book("3", "Python Guide", "Carol Example", "Pub", "Desc", 12.0, 3);
